...
echo $EXE -n $NUM_LEVELS $NORMAL1000_OPTS -i ../../N45E007.hgt -o  "$NEWRES"/"$NORMAL1000" -t "$NEWRES"/"$NORMAL1000"n
...
echo $EXE -n $NUM_LEVELS $SMOOTH1000_OPTS -i ../../N45E007.hgt -o "$NEWRES"/"$SMOOTH1000" -t "$NEWRES"/"$SMOOTH1000"n
